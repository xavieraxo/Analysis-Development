    ...
    public partial class InitialPostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Behaviors", x => x.AgentRole);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    MatchPattern = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternalConversationsJson = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordRecoveryTokens_Email_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemConfigurations_ConfigurationType_Key",
                table: "SystemConfigurations",
                columns: new[] { "ConfigurationType", "Key" },
                unique: true);
